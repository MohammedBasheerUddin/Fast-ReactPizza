...
function CreateOrder() {
  ...
  const numberOfItems = useSelector(getTotalCartQuantity);
    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <span className="font-semibold text-center text-xs px-10 md:text-l"> Order Summary: Total Price: {formatCurrency(totalPrice)}, Number of Items: {numberOfItems} </span>
...
export async function action({ request }) {
  ...
  // If everything is good, create new order;
